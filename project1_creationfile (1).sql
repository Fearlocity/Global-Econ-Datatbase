...
CREATE TABLE Household (
  ...
  FamilySize INT(11) NOT NULL DEFAULT 1,
...
INSERT INTO Household values (1, 1, 5, 3, 100000);
INSERT INTO Household values (301, 2, 2, 0, 75360);
INSERT INTO Household values (200, 3, 10, 8, 253574);
INSERT INTO Household values (47, 4, 3, 1, 65098);
INSERT INTO Household values (53, 5, 2, 1, 27000);
INSERT INTO Household values (301, 1, 2, 0, 5000000);
INSERT INTO Household values (53, 2, 3, 1, 500000);
INSERT INTO Household values (1, 43, 5, 3, 1432052000);
INSERT INTO Household values (86, 742, 2, 0, 100000000);
INSERT INTO Household values (86, 442, 2, 0, 1040304302);
INSERT INTO Household values (86, 543, 2, 0, 430434314);
INSERT INTO Household values (53, 44, 4, 3, 43984);
INSERT INTO HOusehold values (53, 32, 2, 1, 25000);

DROP TABLE IF EXISTS CountryEconomy;
CREATE TABLE CountryEconomy (
  CountryCode2 CHAR(3) NOT NULL DEFAULT '',
  GNP FLOAT DEFAULT NULL,
  OldGNP FLOAT DEFAULT NULL,
  DEBT FLOAT DEFAULT NULL,
  GlobalRank INT(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (CountryCode2),
  FOREIGN KEY (CountryCode2) REFERENCES Country(Code)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8;
INSERT INTO CountryEconomy values ('USA', 21.374712,21.659441, 19.23, 1);
INSERT INTO CountryEconomy values ('CHN', 16.789239, 14.857275, 2.64, 2);
INSERT INTO CountryEconomy values ('JPN', 5.356986, 5.152435, 4.36, 3);
INSERT INTO CountryEconomy values ('DEU', 4.242859, 3.951936, 6.46, 4);
INSERT INTO CountryEconomy values ('GBR', 3.055334, 2.681473, 8.73, 5);
INSERT INTO CountryEconomy values ('IND', 3.055334, 2.641485, .620, 6);
INSERT INTO CountryEconomy values ('FRA', 2.961948, 2.661229, 7.04, 7);
INSERT INTO CountryEconomy values ('ITA', 2.109497, 1.924972, 2.51, 8);
INSERT INTO CountryEconomy values ('CAN', 1.847814, 1.656240, 1.93, 9);
INSERT INTO CountryEconomy values ('KOR', 1.809839, 1.706856,.407, 10);
INSERT INTO CountryEconomy values ('RUS', 1.692597, 1.572763, .489, 11);
INSERT INTO CountryEconomy values ('BRA', 1.651061, 1.658193, .556, 12);
INSERT INTO CountryEconomy values ('AUS', 1.461068, 1.379109, 1.83, 13);
INSERT INTO CountryEconomy values ('ESP', 1.407503, 1.295796, 2.26, 14);
INSERT INTO CountryEconomy values ('MEX', 1.221491, 1.100032, .437, 15);
INSERT INTO CountryEconomy values ('IDN', 1.143081, 1.059880, .395, 16);
INSERT INTO CountryEconomy values ('NLD', 0.988275, 0.890764, .555, 17);
INSERT INTO CountryEconomy values ('TUR', 0.836295, 0.762520, .444, 18);
INSERT INTO CountryEconomy values ('CHE', 0.785903, 0.713590, 1.82, 19);
INSERT INTO CountryEconomy values ('POL', 0.629922, 0.578462, .364, 20);

DROP TABLE IF EXISTS CountryEthnicity;
CREATE TABLE CountryEthnicity (
  CountryCode CHAR(3) NOT NULL DEFAULT '',
  Ethnicity CHAR(20) NOT NULL,
  Percentage FLOAT(4, 2) NOT NULL DEFAULT 0,
  isForeign CHAR(1) NOT NULL DEFAULT '',
  PRIMARY KEY (CountryCode, Ethnicity),
  FOREIGN KEY (CountryCode) REFERENCES Country(Code)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO CountryEthnicity values('USA', 'White', 59.3, 'F');
INSERT INTO CountryEthnicity values('USA', 'Hispanic/Latino', 18.5, 'F');
INSERT INTO CountryEthnicity values('USA', 'African American', 13.6, 'F');
INSERT INTO CountryEthnicity values('USA', 'Native American', 1.3, 'F');
INSERT INTO CountryEthnicity values('USA', 'Asian', '6.1', 'F');
INSERT INTO CountryEthnicity values('USA', 'Hawaiian', .3, 'F');
INSERT INTO CountryEthnicity values('USA', 'Multiple', 2.9, 'F');
